...
def main(args):
    ...
    print("Model loaded with shape mismatch handling (concise version).")
    ...
    for batch in tqdm(dataloader):
        ...
        with torch.no_grad():
            ...
            z = torch.randn(len(images), 3, latents.shape[2], latents.shape[3], device=device, dtype=torch.float32) # Ensure z is float32 and on device
