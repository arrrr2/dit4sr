...
# Calculate weights for 256x256 tile
weights_256 = gaussian_weights(256, 256)

# Calculate weights for 64x64 tile
weights_64 = gaussian_weights(32, 32)

# Convert to PyTorch tensor if needed
weights_256_tensor = torch.tensor(weights_256)
weights_64_tensor = torch.tensor(weights_64)

print(weights_64_tensor[0])