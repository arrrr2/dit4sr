...
from lit import LinearAttention
...
if __name__=="__main__":
    ...
    device = "cuda:2"
    model = DiT_XS_1(input_size=64)
    from torch.utils.flop_counter import FlopCounterMode
    

    input = torch.randn(16, 16, 64, 64)
    y = torch.randn(16, 16, 64, 64)
    t = torch.randn(16)
    ...
    if torch.cuda.is_available():
        ...
        with torch.autocast("cuda"): model(input, t, y=y)
        torch.cuda.synchronize(device=device)
