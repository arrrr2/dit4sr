...
from .gaussian_diffusion import ResShiftDiffusion, ResShiftDiffusionDDPM

def resshift_space_timesteps(num_timesteps, sample_timesteps):
    """
...
class ResShiftSpacedDiffusion(ResShiftDiffusion):
    ...
    def __init__(self, use_timesteps, **kwargs):
        ...
        base_diffusion = ResShiftDiffusion(**kwargs)  # pylint: disable=missing-kwoa
        new_sqrt_etas = []
...
class ResShiftSpacedDiffusionDDPM(ResShiftDiffusionDDPM):
    ...
    def __init__(self, use_timesteps, **kwargs):
        ...
        base_diffusion = ResShiftDiffusionDDPM(**kwargs)  # pylint: disable=missing-kwoa
